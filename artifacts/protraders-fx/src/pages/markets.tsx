  ...
  return <Workspace title="Markets" eyebrow="Market observatory" description="Transparent Deriv data with freshness visible at every layer.">
    <div className="grid gap-5 lg:grid-cols-[250px_1fr]">
      ...
      <div className="space-y-5">
        ...
        <div className="grid gap-5 md:grid-cols-3"><DataCard label="Bid / ask" value={tick?.bid && tick?.ask ? `${tick.bid} / ${tick.ask}` : "Unavailable"} /><DataCard label="Freshness" value={ticker.isFetching?"Syncing":"Auto-refresh 3s"} /><DataCard label="Analysis" value={candle?.indicators ? "Deterministic indicators" : "Not available"} /></div>
      </div>
    </div>
  </Workspace>
}
